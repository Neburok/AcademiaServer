...
from .schemas import canonicalize_note
...
def generate_daily_id():
    ...
    daily_ids = [f for f in existing_files if f.startswith(today_str)]
...
def list_ideas():
    ...
    return sorted(os.listdir(INBOX_DIR))
...
def load_all_ideas():
    ...
    for filename in files:
        ...
        try:
            ...
            print(f"Archivo corrupto ignorado: {filename}")
            continue
...
def search_ideas(query: str, backend: str = "keyword"):
